...
twoway ///
    ...
    xtitle("h (상대시점, 월)") ///
    ytitle("Log 수입가격 반응 (할당관세적용시)") ///
    legend(order(3 "처치그룹1" 4 "처치그룹2") pos(6) ring(0)) ///
    yline(0) xline(-1)
graph export LPseparateMAX파양가_noGm4.png, replace width(3000)
...
twoway ///
    ...
    ytitle("Log Import Price Response (under TRQ)") ///
    legend(order(3 "Treated Group 1" 4 "Treated Group 2") pos(6) ring(0)) ///
    yline(0) xline(-1)
graph export LPseparateMAX파양가_noGm4_eng.png, replace width(3000)
