...
export delimited using "LPseparate_noGm4_CV1(95)ct_impulse_res.csv", replace
...
twoway ///
    ...
    yline(0) xline(-1)
graph export "LPseparate_noGm4_CV1(95)ct_impulse.png", replace width(3000)
...
twoway ///
    ...
    ytitle("Log Retail Price Response (under Quota Tariff)") ///
    legend(order(3 "Treated Group 1" 4 "Treated Group 2") pos(6) ring(0)) ///
    yline(0) xline(-1)
graph export "LPseparate_noGm4_CV1(95)ct_impulse_eng.png", replace width(3000)
...
twoway ///
    ...
    legend(order(3 "Treated Group 1" 4 "Treated Group 2") pos(6) ring(0)) ///
    yline(0) xline(-1)
graph export "LPseparate_noGm4_CV1(95)ct_impulse_eng_short.png", replace width(3000)
