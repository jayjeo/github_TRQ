...
file open _tabh using "tabh_Gbase.csv", write replace
...
tempfile g1base
save "`g1base'", replace
* [TABH] intensity extraction (group1 = vegetables)
preserve
keep if d==1
collapse (mean) intensity TRQall, by(qcode q_item)
gen double tau = intensity + TRQall
export delimited using "tabh_intensity_veg.csv", replace
restore
    ...
    * Clean controls: new treatment (clean event) vs clean control (prevtr120==0)
    ...
    if (`Nall'==0 | `NT'==0 | `Nc'==0) {
        ...
        * Wild cluster bootstrap CI only when usewb=1 (unstable in the tails)
        ...
        file write _tabh "Gbase,1,`h',`bb',`ss',`=e(N)',`=e(r2)',`=e(r2_a)',`=e(df_r)',`=e(N_clust)'" _n
...
tempfile g2base
save "`g2base'", replace
* [TABH] intensity extraction (group2 = fruits)
preserve
keep if d==1
collapse (mean) intensity TRQall, by(qcode q_item)
gen double tau = intensity + TRQall
export delimited using "tabh_intensity_fruit.csv", replace
restore
...
foreach h in 150 {
    ...
    if (`Nall'==0 | `NT'==0 | `Nc'==0) {
        ...
        * Fruit regressions: drop the climate interactions (4 current + 4 L365), keep oil x item
        ...
        file write _tabh "Gbase,2,`h',`bb',`ss',`=e(N)',`=e(r2)',`=e(r2_a)',`=e(df_r)',`=e(N_clust)'" _n
...
export delimited using "LPseparate_Gm4_CV1(95)ct_res_TABHVAR.csv", replace
