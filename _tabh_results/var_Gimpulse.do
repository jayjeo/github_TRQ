...
file open _tabh using "tabh_Gimpulse.csv", write replace
    ...
    * Average cumulative treated days across treated events (raw/bridged)
    ...
    if (`Nall'==0 | `NT'==0 | `Nc'==0) {
        ...
        * Wild cluster bootstrap CI only when usewb=1 (unstable in the tails)
        ...
        file write _tabh "Gimpulse,1,`h',`bb',`ss',`=e(N)',`=e(r2)',`=e(r2_a)',`=e(df_r)',`=e(N_clust)'" _n
    ...
    * Average cumulative treated days across treated events (raw/bridged)
    ...
    if (`Nall'==0 | `NT'==0 | `Nc'==0) {
        ...
        * Fruit regressions: drop the climate interactions (4 current + 4 L365), keep oil x item
        ...
        file write _tabh "Gimpulse,2,`h',`bb',`ss',`=e(N)',`=e(r2)',`=e(r2_a)',`=e(df_r)',`=e(N_clust)'" _n
...
export delimited using "LPseparate_Gm4_CV1(95)ct_impulse_res_TABHVAR.csv", replace
